...
export async function postPostLike(id) {
    const token = getToken();
    const res = await fetch(`${api}/content/posts/${id}/like`, {
        method: "POST",
        headers: {
            Authorization: `Bearer ${token}`,
        },
...
export async function deletePostLike(id) {
    const token = getToken();
    const res = await fetch(`${api}/content/posts/${id}/unlike`, {
        method: "DELETE",
        headers: {
            Authorization: `Bearer ${token}`,
        },
...
export async function fetchPostLikes(id) {
    const res = await fetch(`${api}/content/posts/${id}/likes`);
    return res.json();
}

export async function fetchCommentLikes(id) {
    const res = await fetch(`${api}/content/comments/${id}/likes`);
    return res.json();
}

export async function postCommentLike(id) {
    const token = getToken();
    const res = await fetch(`${api}/content/comments/${id}/like`, {
        method: "POST",
        headers: {
            Authorization: `Bearer ${token}`,
        },
...
export async function deleteCommentLike(id) {
    const token = getToken();
    const res = await fetch(`${api}/content/comments/${id}/unlike`, {
        method: "DELETE",
        headers: {
            Authorization: `Bearer ${token}`,
        },
